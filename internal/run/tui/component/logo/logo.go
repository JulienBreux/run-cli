...
func New() *tview.TextView {
	...
	_, _ = fmt.Fprint(logoText, StringSimple())
	return logoText
}

// String returns the logo as a string (with attribution).
func String() string {
...
// StringSimple returns the logo as a string without attribution.
func StringSimple() string {
	var logo strings.Builder
	logoArt := []string{
		color + " ___ _   _ _  _ ",
		color + "| _ \\ | | | \\| |",
